...
class Control_dynamics_1:
    ...
    def f(self, x, u, t, jacobian=False):
        ...
        f_dyn = np.array([math.cos(q[5]) * v[2] * math.sin(q[4]) * math.cos(q[3]) + math.cos(q[5]) * v[1] * math.sin(q[4]) * math.sin(q[3]) + math.cos(q[5]) * math.cos(q[4]) * v[0] + math.sin(q[5]) * v[2] * math.sin(q[3]) - math.sin(q[5]) * v[1] * math.cos(q[3]),math.sin(q[5]) * v[2] * math.sin(q[4]) * math.cos(q[3]) + math.sin(q[5]) * v[1] * math.sin(q[4]) * math.sin(q[3]) - math.cos(q[5]) * v[2] * math.sin(q[3]) + math.cos(q[5]) * v[1] * math.cos(q[3]) + math.sin(q[5]) * math.cos(q[4]) * v[0],math.cos(q[4]) * math.cos(q[3]) * v[2] + math.cos(q[4]) * math.sin(q[3]) * v[1] - math.sin(q[4]) * v[0],(v[3] * math.cos(q[3]) ** 2 * math.cos(q[4]) + v[3] * math.sin(q[3]) ** 2 * math.cos(q[4]) + math.sin(q[4]) * math.sin(q[3]) * v[4] + math.sin(q[4]) * math.cos(q[3]) * v[5]) / math.cos(q[4]) / (math.cos(q[3]) ** 2 + math.sin(q[3]) ** 2),(math.cos(q[3]) * v[4] - math.sin(q[3]) * v[5]) / (math.cos(q[3]) ** 2 + math.sin(q[3]) ** 2),(math.sin(q[3]) * v[4] + math.cos(q[3]) * v[5]) / math.cos(q[4]) / (math.cos(q[3]) ** 2 + math.sin(q[3]) ** 2),-0.1e1 / m * (g * math.sin(q[4]) * m + v[4] * v[2] - v[5] * v[1]),(g * math.cos(q[4]) * math.sin(q[3]) * m + v[3] * v[2] - v[5] * v[0]) / m,-0.1e1 / m * (-g * math.cos(q[4]) * math.cos(q[3]) * m + v[3] * v[1] - v[4] * v[0] - u[0]),0.1e1 / Ixx * (v[5] * Iyy * v[4] - v[4] * Izz * v[5] + u[1]),-0.1e1 / Iyy * (v[5] * Ixx * v[3] - v[3] * Izz * v[5] - u[2]),0.1e1 / Izz * (v[4] * Ixx * v[3] - v[3] * Iyy * v[4] + u[3])])
